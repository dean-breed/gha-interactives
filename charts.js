...
svg.append("path")
    .datum(data)
	.filter(function(d) {return d.region == 'total'})
    ...
    .on("mousemove", function(d) {
        ...
        var closest_value = data.filter(function(d){return Math.abs(xPosition - d.dd) == closest_year_distance})[0].cases;
        console.log(d);
...
function draw_area_figure_2b(data, chart_id, margin, width, height,chart_config){
